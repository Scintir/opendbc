...
class HyundaiSafetyFlagsSP:
  ...
  HAS_LDA_BUTTON = 4
  NON_SCC = 8
  BMS_UDS = 16  # allow read-only UDS polling of the BMS on the OBD-II port (bus 1)
...
class HyundaiFlagsSP(IntFlag):
  ...
  HAS_LKAS12 = 2 ** 10
  BMS_UDS_POLLING = 2 ** 11  # poll the BMS over UDS on the OBD-II port for HV battery state (EvBmsUdsPolling param)
